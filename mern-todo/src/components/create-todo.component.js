                    ...
                    <form onSubmit={this.onSubmit}>
                        <div className="form-group"> 
                            <input  type="text"
                                    ...
                                    onChange={this.onChangeTodoName} placeholder="Name"
                                    />
                        </div>
                        <div className="form-group">
                            <input 
                                    ...
                                    onChange={this.onChangeTodoEmail} placeholder="Email"
                                    />
                        </div>
                        <div className="form-group">
                            <input 
                                    ...
                                    onChange={this.onChangeTodoPhone} placeholder="Phone"
                                    />
                        </div>
                        <div className="form-group">
                        ...
                        <div className="form-group">
                            <input type="submit" value="Add Contact" className="btn btn-primary col-md-12" />
                        </div>
                    </form>
                </div>
            </div>
